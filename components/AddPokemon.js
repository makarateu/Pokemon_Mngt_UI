...
const AddPokemon = () => {
  ...
  const [responsePokemon, setResponsePokemon] = useState({
    id: "",
    name: "",
    price: 0.0,
    imageUrl: "",
    ...
    <>
      <div className="container mx-auto my-8">
        <div className="h-12">
          <button
            onClick={openModal}
            className="rounded bg-orange-600 text-white px-6 py-2 font-semibold">
            Add Pokemon
          </button>
        </div>
      </div>
      ...
      <PokemonList pokemon={responsePokemon} />
    </>
  );
};
